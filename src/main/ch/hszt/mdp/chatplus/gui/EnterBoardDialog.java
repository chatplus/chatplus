...
public class EnterBoardDialog extends JDialog {
	...
	private static final long serialVersionUID = 2621819127862608518L;
		...
		layout.setVerticalGroup(layout.createParallelGroup(
				...
				layout.createSequentialGroup().addContainerGap().addGroup(
						layout.createParallelGroup(
								...
								boardNameLabel).addComponent(boardName,
								GroupLayout.PREFERRED_SIZE,
								GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)).addPreferredGap(
						LayoutStyle.ComponentPlacement.RELATED).addComponent(
						enterBoardButton).addContainerGap(
	...
	public static void main(String args[]) {
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				EnterBoardDialog dialog = new EnterBoardDialog(new JFrame(),
						true);
